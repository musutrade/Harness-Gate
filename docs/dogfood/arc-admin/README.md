...
Follow-on records: [execution import (GH-202)](import/README.md) and [generic quality configuration (GH-203)](quality/README.md). These preserve this frozen baseline; runtime parity and authority transfer remain pending.
