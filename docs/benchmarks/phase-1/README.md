...
The five-sample verification medians are 0.656s serial and 0.355s parallel
with a configured and observed peak of two workers. The test warm median is
4.344s after a 32.387s cold sample. The release-small binary is 7,953,272
bytes with SHA-256
