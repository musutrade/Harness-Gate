...
从不可变的 [GitHub Release tag](https://github.com/musutrade/Harness-Gate/releases/tag/v0.3.4) 下载适合你平台的二进制文件：
...
curl --fail --show-error --location --proto '=https' --tlsv1.2 \
  ...
  https://raw.githubusercontent.com/musutrade/Harness-Gate/v0.3.4/install.sh
bash /tmp/harness-gate-install.sh --version v0.3.4
...
cosign verify-blob --signature harness-gate-linux-amd64.sig \
  ...
  --certificate-identity-regexp '^https://github.com/musutrade/Harness-Gate/.github/workflows/release\.yml@refs/tags/v0\.3\.4$' \
