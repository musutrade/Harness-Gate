...
- [ ] **5.1 (P3, S)** Record reproducible baseline benchmarks for fast/slow
...
- [ ] **5.4 (P3, S)** Compare post-change benchmarks and publish the result.
...
- [ ] **6.1 (P2, M)** Replace per-item whole-config cloning with borrowed
