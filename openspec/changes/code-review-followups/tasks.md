...
- [x] Publish dependency-blocked steps in JSON, Markdown, and JUnit reports;
  add regression tests while preserving successful snapshots.
- [x] Make the benchmark fixture and quality baseline workflow portable across
