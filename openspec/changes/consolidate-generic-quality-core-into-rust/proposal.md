...
**Status:** Implementation in progress: tasks 1.1–3.2 merged with required CI complete (GH-146–GH-148). Tasks 4.1–4.2 are implemented in GH-149; validation is recorded with that slice. Tasks 5–7 and authority transfer are not accepted.
**Date:** 2026-09-08
