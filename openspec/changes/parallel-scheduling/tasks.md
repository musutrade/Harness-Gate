...
- [ ] **1.1 (P0, S)** Capture the pre-scheduler serial execution contract.
...
- [ ] **1.2 (P0, S)** Approve the `[execution]` schema and diagnostics.
...
- [ ] **1.3 (P0, S)** Define scheduler state and policy registry.
...
- [ ] **2.1 (P0, M)** Specify the scheduler input/output boundary.
...
- [ ] **2.2 (P0, M)** Define deterministic ready-queue dispatch.
...
- [ ] **2.3 (P0, M)** Define descendant blocking and unrelated-branch behavior.
...
- [ ] **2.4 (P1, S)** Verify built-in gate compatibility.
...
- [ ] **3.1 (P0, M)** Define adapter resource identity and shareability.
...
- [ ] **3.2 (P0, M)** Define task-local execution context and environment rules.
...
- [ ] **3.3 (P0, M)** Define unique log allocation and containment.
...
- [ ] **3.4 (P0, M)** Define the ordered result publisher.
...
- [ ] **5.1 (P1, M)** Prepare deterministic serial/parallel benchmark fixtures.
...
- [ ] **5.2 (P1, M)** Prepare service-contention and repeated-run fixtures.
...
- [ ] **5.3 (P0, M)** Prepare CLI/report/error compatibility snapshots.
...
- [ ] **5.4 (P1, S)** Define benchmark comparison and regression governance.
...
- [ ] **6.1 (P1, S)** Update configuration and migration documentation.
...
- [ ] **6.2 (P0, S)** Run specification and evidence review.
...
- [ ] **6.3 (P0, S)** Update ADR/OpenSpec status after implementation only.
