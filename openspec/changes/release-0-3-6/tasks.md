...
- [ ] Run focused and full local release validation.
...
- [ ] Approve the protected release environment and verify publication.
- [ ] Verify the published inventory, checksums, signatures, provenance,
  crate, and clean-environment installer flow.
- [ ] Record final release evidence and mark this release record Implemented.
