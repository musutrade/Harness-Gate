...
SERIES = {"analyzer": "harness-gate-rust-measure/0.3.0", "rule": "mccabe-rust-3/1",
          ...
          "selection": "gh183-quality-verification/2"}
...
SOURCE_FILES = sorted(set(HOTSPOTS) | {"app/mod.rs", "app/quality.rs", "cli.rs", "lib.rs", "config/mod.rs", "process/mod.rs", "failure.rs", "verify/quality.rs", "verify/report.rs"} |
