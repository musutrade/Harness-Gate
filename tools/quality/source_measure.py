...
SERIES = {"analyzer": "harness-gate-rust-measure/0.3.0", "rule": "mccabe-rust-3/1",
          ...
          "selection": "gh183-quality-verification/1"}
...
SOURCE_FILES = sorted(set(HOTSPOTS) | {"app/mod.rs", "app/quality.rs", "cli.rs", "lib.rs", "config/mod.rs", "process/mod.rs", "verify/quality.rs"} |
