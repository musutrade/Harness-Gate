...
def acceptance(path, pin, binary):
    ...
    require(len(names) == len(checks) and len(checks) >= 74
            and {'doctor', 'plain', 'boundaries', 'features', 'verify', 'failed-test',
                 ...
                 'file-summary-disagreement',
                 'total-lines-count', 'total-lines-covered',
                 'total-functions-count', 'total-functions-covered',
                 'total-instantiations-count', 'total-instantiations-covered',
